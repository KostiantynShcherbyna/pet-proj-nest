...
import { AuthQueryRepository } from "../../auth/infrastructure/mongoose/auth.query.repository"
...
import { DevicesSqlQueryRepository } from "../infrastructure/sql/devices.sql.query.repository"
